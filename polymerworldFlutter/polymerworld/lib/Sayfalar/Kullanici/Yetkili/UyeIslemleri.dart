...
class UyeIslemleri extends StatelessWidget {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'ÜYE İŞLEMLERİ', // Kullanıcının adı veya başlık
              ...
              Column(
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary: const Color.fromARGB(
                          255, 124, 33, 243), // ÜYE EKLE butonunun rengi
                      minimumSize:
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary: const Color.fromARGB(
                          255, 175, 152, 76), // ÜYE LİSTESİ butonunun rengi
                      minimumSize:
                          Size(400, 150), // Genişlik ve yükseklik belirtildi
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10),
