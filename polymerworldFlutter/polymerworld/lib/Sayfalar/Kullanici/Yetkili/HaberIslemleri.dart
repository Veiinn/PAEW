...
class HaberIslemleri extends StatelessWidget {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'HABER İŞLEMLERİ', // Kullanıcının adı veya başlık
              ...
              Column(
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary: Color.fromARGB(
                          255, 33, 243, 79), // ÜYE EKLE butonunun rengi
                      minimumSize:
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary: Color.fromARGB(
                          255, 76, 127, 175), // ÜYE LİSTESİ butonunun rengi
                      minimumSize:
                          Size(400, 150), // Genişlik ve yükseklik belirtildi
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10),
