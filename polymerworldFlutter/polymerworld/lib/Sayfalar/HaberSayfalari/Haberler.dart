...
import 'package:polymerworld/Sayfalar/HaberSayfalari/Haber.dart';
...
class _HaberlerPageState extends State<Haberler> {
  ...
  Future<void> fetchKategoriler() async {
    final newsApi = NewsApi();
    final response = await newsApi.getHaberKategoriler();
    setState(() {
